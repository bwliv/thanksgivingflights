...
file2015 = mutate(file2015,period = ifelse(FL_DATE >= ymd('2015-11-25'),'Thanksgiving','Pre-Thanksgiving'))
file2016 = mutate(file2016,period = ifelse(FL_DATE >= ymd('2016-11-23'),'Thanksgiving','Pre-Thanksgiving'))
file2017 = mutate(file2017,period = ifelse(FL_DATE >= ymd('2017-11-22'),'Thanksgiving','Pre-Thanksgiving'))
file2018 = mutate(file2018,period = ifelse(FL_DATE >= ymd('2018-11-21'),'Thanksgiving','Pre-Thanksgiving'))
