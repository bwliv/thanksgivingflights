---
title: "Why Flying During The Thanksgiving Holiday |Isn't All That Bad"
author: "Siddhant Shandilya, Benjamin Livingston, |Amogh Mishra, and Mohit Gulla"
...
We will present these airlines graphically sorted from the largest airline to the smallest, and keep this consistent throughout the presentation.
...
ggplot(by_airport_delay,aes(x=fct_reorder(ORIGIN,delay),y=delay,fill=fct_rev(period))) + 
  ...
  xlab('') +
  ylab('Average Arrival Delay (Minutes)') +
  ggtitle('Departure Delays For For Flights Originating From Top 10 US Airports Before/During Thanksgiving Holiday') +
...
ggplot(cancellations_by_aiport,aes(x=fct_reorder(ORIGIN,cancelled_per_day),y=cancelled_per_day,fill=fct_rev(period))) + 
  ...
  ggtitle('Flight Cancellations Per Day For Flights Originating From Top 10 US Airports Before/During Thanksgiving Holiday') +
  labs(subtitle = '20 Days Before Thanksgiving Holiday vs. Five Days Of Thanksgiving Holiday') +
  theme(plot.title = element_text(hjust = 0.5,size=16))  +
