...
First, we offer a graph that will allow you to compare average delays for the airlines flying between any pair of cities that had a direct flight to speak of (if no direct flights occured, no data will be shown). 
...
Second, we present a map that will allow you to visualize the average delays for flights out of select major airports across the country. 

### MOHIT GRAPH HERE

These vizualizations are too complex and customizable to distill into sweeping statements, so we will allow you to draw your own conclusions from them. 
